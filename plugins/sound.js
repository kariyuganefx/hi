...
 conn.sendFile(m.chat, 'https://a.uguu.se/MVvxdyON.mp3', 'https://a.uguu.se/AghHOZSH.mp3', null, m, true, {
type: 'audioMessage', 
ptt: true, contextInfo: {
        externalAdReply: { showAdAttribution: true, title: `${ucapan()}`, body: 'It will be processed shortly', sourceUrl: `${pickRandom([`https://www.facebook.com/`,`https://instagram.com/`,`https://github.com/`,`https://youtu.be/`])}`, thumbnail: await (await fetch('https://i.imgur.com/4rRZ4c7.jpeg')).buffer(),}} 
     })
await delay(1900)
