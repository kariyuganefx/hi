...
`.trim()
        ...
        if (room.x !== room.o) await this.sendButton(room.x, str, wm, isWin ? 'TicTacToe' : isTie ? 'TicTacToe' : 'Give up', isWin ? '.ttt' : isTie ? '.ttt' : 'give up', m)
        await this.sendButton(room.o, str, wm, isWin ? 'TicTacToe' : isTie ? 'TicTacToe' : 'Give up', isWin ? '.ttt' : isTie ? '.ttt' : 'give up', m)
        if (isTie || isWin) {
