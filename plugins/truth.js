let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    await conn.sendButton(m.chat, `“${pickRandom(global.truth)}”`, wm,null,null,'NEXT PLAYER', `.tod` , 'PICK DARE',`.dare` )
  }
  handler.help = ['truth']
  handler.tags = ['fun']
  ...
  global.truth = [
   ...
   "Do you support turbo mods?",
   "Did you subscribed to turbo mods?",
   "Do you like phoenix bot?",
   "Do you have crush on turbo?",
